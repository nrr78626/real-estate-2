...
const EditPropertyDetailsModal = ({ setOpenEditPropertyDetailsModal, openEditPropertyDetailsModal, params }) => {

    const [updatePropertyDetails, setUpdatePropertyDetails] = useState({ purpose: "", propertyType: "", title: "", address: "", rooms: "", baths: "", price: "", sqft: "", description: "", condition: "", airConditionb: "", balcony_or_terrace: "", gym_or_health_club: "", swimmingPool: "", jacuzzi: "", sauna: "", steam_Room: "", maintenance_staff: "", securityStaff: "", coverVideo: "", emial: "", contact: "", fullname: "" })
    ...
    if (!openEditPropertyDetailsModal) {
        return null
    }
    return (
        <div id='myModal' className='fixed inset-0 z-50 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center shadow shadow-black transition-all duration-500'>
            <div className='bg-white py-10 px-10 rounded flex flex-col overflow-scroll'>
                ...
                <form className="font-[sans-serif] m-6 max-w-4xl mx-auto" onSubmit={handleOnSubmit}>
                    <div className="grid sm:grid-cols-2 gap-10">
                        {/* <div className="relative flex items-center">
                            ...
                            <input value={updatePropertyDetails.title} onChange={handleOnChange} type="text" placeholder="Title"
                        ...
                        {/* <div className="relative flex items-center">
                            ...
                            <input value={updatePropertyDetails.propertyType} onChange={handleOnChange} type="text" placeholder="Type"
                        ...
                        <div className="relative flex items-center">
                            ...
                            <input value={updatePropertyDetails.price} onChange={handleOnChange} type="number" placeholder="Price"
                        ...
                        <div className="relative flex items-center">
                            ...
                            <input value={updatePropertyDetails.rooms} onChange={handleOnChange} type="number" placeholder="Rooms"
                        ...
                        <div className="relative flex items-center">
                            ...
                            <input value={updatePropertyDetails.baths} onChange={handleOnChange} type="number" placeholder="Bathrooms"
                        ...
                        <div className="relative flex items-center">
                            ...
                            <input value={updatePropertyDetails.sqft} onChange={handleOnChange} type="number" placeholder="Area"
                        ...
                        <div className="relative flex items-center">
                            ...
                            <input value={updatePropertyDetails.coverVideo} onChange={handleOnChange} type="text" placeholder="Video ID"
                        ...
                        <div className="relative flex items-center">
                            ...
                            <select onChange={handleOnChange} value={updatePropertyDetails.purpose} type="text" placeholder="Propose"
                        ...
                        <div className="relative flex items-center">
                            ...
                            <select onChange={handleOnChange} value={updatePropertyDetails.status} type="text" placeholder="Status"
                        ...
                        <div className="relative flex items-center sm:col-span-2">
                            ...
                            <textarea onChange={handleOnChange} value={updatePropertyDetails.description} name="description" id="" cols="30" rows="3" className='px-4 py-3.5 bg-white text-gray-800 w-full text-sm border-2 border-gray-100 focus:border-blue-500 rounded outline-none'></textarea >
                        </div>
                        <div className="relative flex items-center sm:col-span-2">
                            <label
                                className="text-[13px] bg-white text-gray-800 absolute px-2 top-[-10px] left-[18px] font-semibold">Address</label>
                            <textarea value={updatePropertyDetails.address} onChange={handleOnChange} name="address" id="" cols="30" rows="3" className='px-4 py-3.5 bg-white text-gray-800 w-full text-sm border-2 border-gray-100 focus:border-blue-500 rounded outline-none'></textarea >
                        </div>
                        ...
                        <div className="relative flex flex-col items-center sm:col-span-2 w-full gap-3">
                            ...
                            <div className='flex'>
                                <div className="relative flex items-center">
                                    ...
                                    <input value={updatePropertyDetails.fullname} onChange={handleOnChange} type="text" placeholder="Fullname"
                                ...
                                <div className="relative flex items-center">
                                    ...
                                    <input value={updatePropertyDetails.email} onChange={handleOnChange} type="email" placeholder="Email"
                                ...
                                <div className="relative flex items-center">
                                    ...
                                    <input value={updatePropertyDetails.contact} onChange={handleOnChange} type="text" placeholder="Contact"
